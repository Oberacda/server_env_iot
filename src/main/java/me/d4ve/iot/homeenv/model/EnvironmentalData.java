...
public class EnvironmentalData {
    ...
    public EnvironmentalData(Timestamp timestamp, Double temperature, Double humidity, Double pressure, Double illuminance, Double uva, Double uvb, Double uv_index) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, getTimestamp(), getTemperature(), getHumidity(), getPressure(), getIlluminance(), getUva(), getUvb(), getUv_index());
    }
}
